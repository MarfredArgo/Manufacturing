...
function submitEditWorker(e) {
    ...
    .then(res => res.json())
    .then(() => { closeEditWorkerModal(); showSuccess('Worker updated successfully'); setTimeout(() => location.reload(), 800); });
}
...
function confirmDeleteWorker() {
    ...
    .then(res => res.json())
    .then(() => { closeEditWorkerModal(); showSuccess('Worker deleted successfully'); setTimeout(() => location.reload(), 800); });
}
...
function submitAddWorker(e) {
    ...
    .then(res => res.json())
    .then(() => { closeAddWorkerModal(); showSuccess('Worker added successfully'); setTimeout(() => location.reload(), 800); });
}
